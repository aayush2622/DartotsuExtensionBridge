...
import com.lagradost.cloudstream3.WebViewResolver
    ...
    override suspend fun getUrl(
        ...
        if (!directStreamUrl.isNullOrEmpty()) {
            ...
            val interceptedStreamUrl = app.get(
                ...
                // NiceHttp 0.4.16 doesn't seem to have interceptor in standard get, 
                // but we can't easily fix specialized WebViewResolver usage if it expects it.
                // Assuming NiceHttp version might be the issue.
            ).url
