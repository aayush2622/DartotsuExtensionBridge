...
import '../../../androidx/preference/PreferenceScreen.dart'
    as preferencescreen$_;
...
extension AniyomiExtensionApi$$Methods on AniyomiExtensionApi {
  ...
  /// The returned object must be released after use, by calling the [release] method.
  jni$_.JMap<jni$_.JString, preferencescreen$_.PreferenceScreen>
  get preferenceScreenMap {
    final _$$selfRef = reference;
    return _get$preferenceScreenMap(
      _$$selfRef.pointer,
      _id_get$preferenceScreenMap.pointer,
    ).object<jni$_.JMap<jni$_.JString, preferencescreen$_.PreferenceScreen>>();
  }
