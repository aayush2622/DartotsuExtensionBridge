...
import '../../../kotlin/coroutines/Continuation.dart' as continuation$_;

import 'ExtensionApi.dart' as extensionapi$_;

import 'common/BridgeCallbacks.dart' as bridgecallbacks$_;

import 'common/ExtensionBridgeApi.dart' as extensionbridgeapi$_;

/// from: `com.aayush262.dartotsu_extension_bridge.CloudStreamExtensionApi`
extension type CloudStreamExtensionApi._(jni$_.JObject _$this)
    implements
        jni$_.JObject,
        extensionapi$_.ExtensionApi,
        extensionbridgeapi$_.ExtensionBridgeApi {
  static final _class = jni$_.JClass.forName(
    r'com/aayush262/dartotsu_extension_bridge/CloudStreamExtensionApi',
  );

  /// The type which includes information such as the signature of this class.
  static const jni$_.JType<CloudStreamExtensionApi> type =
      $CloudStreamExtensionApi$Type$();
  ...
  factory CloudStreamExtensionApi() {
    final _$$classRef = _class.reference;
    return _new$(
      _$$classRef.pointer,
      _id_new$.pointer,
    ).object<CloudStreamExtensionApi>();
  }
}

extension CloudStreamExtensionApi$$Methods on CloudStreamExtensionApi {
  static final _id_initClient = CloudStreamExtensionApi._class.instanceMethodId(
    r'initClient',
  ...
  static final _id_initializeDesktop = CloudStreamExtensionApi._class
  ...
  static final _id_getInstalledAnimeExtensions = CloudStreamExtensionApi._class
      .instanceMethodId(
  ...
  static final _id_getInstalledMangaExtensions = CloudStreamExtensionApi._class
      .instanceMethodId(
  ...
  static final _id_getPopular = CloudStreamExtensionApi._class.instanceMethodId(
    r'getPopular',
  ...
  static final _id_getLatestUpdates = CloudStreamExtensionApi._class
      .instanceMethodId(
        r'getLatestUpdates',
        r'(Ljava/lang/String;ZILkotlin/coroutines/Continuation;)Ljava/lang/Object;',
      );
  ...
  static final _id_search = CloudStreamExtensionApi._class.instanceMethodId(
    r'search',
  ...
  static final _id_getDetail = CloudStreamExtensionApi._class.instanceMethodId(
    r'getDetail',
  ...
  static final _id_getVideoList = CloudStreamExtensionApi._class.instanceMethodId(
    r'getVideoList',
    r'(Ljava/lang/String;ZLjava/lang/String;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;',
  );
  ...
  static final _id_getPageList = CloudStreamExtensionApi._class.instanceMethodId(
    r'getPageList',
    r'(Ljava/lang/String;ZLjava/lang/String;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;',
  );
  ...
  static final _id_getPreference = CloudStreamExtensionApi._class.instanceMethodId(
    r'getPreference',
  ...
  static final _id_saveSourcePreference = CloudStreamExtensionApi._class
      .instanceMethodId(
  ...
  static final _id_initializeAndroid = CloudStreamExtensionApi._class
  ...
  static final _id_initialize = CloudStreamExtensionApi._class.instanceMethodId(
    r'initialize',
    r'(Lcom/aayush262/dartotsu_extension_bridge/common/BridgeCallbacks;)V',
  );
  ...
  /// from: `public void initialize(com.aayush262.dartotsu_extension_bridge.common.BridgeCallbacks bridgeCallbacks)`
  void initialize(bridgecallbacks$_.BridgeCallbacks bridgeCallbacks) {
    final _$$selfRef = reference;
    final _$bridgeCallbacks = bridgeCallbacks.reference;
    _initialize(
      _$$selfRef.pointer,
      _id_initialize.pointer,
      _$bridgeCallbacks.pointer,
    ).check();
  }
}

final class $CloudStreamExtensionApi$Type$
    extends jni$_.JType<CloudStreamExtensionApi> {
  @jni$_.internal
  const $CloudStreamExtensionApi$Type$();

  @jni$_.internal
  @core$_.override
  String get signature =>
      r'Lcom/aayush262/dartotsu_extension_bridge/CloudStreamExtensionApi;';
}
