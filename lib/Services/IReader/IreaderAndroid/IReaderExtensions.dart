...
class IReaderExtensions extends Extension with TachiyomiRepoBackend {
  @override
  ...
  Future<void> uninstallSource(Source source) async {
    ...
    try {
      ...
      if (!isInstalled) {
        ...
        // the same way the two paths above/below do, instead of leaving the
