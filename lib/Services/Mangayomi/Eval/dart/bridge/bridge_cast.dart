...
/// 'BridgedMethodCallable' is not a subtype of type 'List'`. That names
/// neither the property nor the mistake, and the extension author has no way
/// to work back to the line.
