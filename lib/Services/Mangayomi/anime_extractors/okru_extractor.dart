...
class OkruExtractor {
  ...
  Future<List<Video>> videosFromUrl(
    ...
    // an unexpected host page shape (a changed data-options JSON layout,
    // here) must fail just this one extractor, not the whole getVideoList
    // call it's aggregated into.
    try {
