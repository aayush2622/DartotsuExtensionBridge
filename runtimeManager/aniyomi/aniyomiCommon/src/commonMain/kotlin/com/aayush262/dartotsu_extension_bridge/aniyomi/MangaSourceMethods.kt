...
class MangaSourceMethods(sourceID: String) : AniyomiSourceMethods {
    ...
    // These build through the SXxx.create() factories rather than anonymous `object :` bodies so
    // that adding a field to the source-api (as extensions-lib 17 / tachiyomix 1.7 did) doesn't
    // break this file.
