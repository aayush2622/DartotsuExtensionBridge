...
class AniyomiBridge(private val context: Context) {
    ...
    private inner class Handler : MethodChannel.MethodCallHandler {
        ...
        private fun getInstalledAnimeExtensions(call: MethodCall, result: MethodChannel.Result) =
            kotlinx.coroutines.launch(call, result) {
        ...
        private fun getDetail(call: MethodCall, result: MethodChannel.Result) = kotlinx.coroutines.launch(call, result) {
            val sourceId = call.arg<String>("sourceId")
            val isAnime = call.arg<Boolean>("isAnime")
        ...
        private fun getVideoList(call: MethodCall, result: MethodChannel.Result) = kotlinx.coroutines.launch(call, result) {
            val sourceId = call.arg<String>("sourceId")
            val isAnime = call.arg<Boolean>("isAnime")
        ...
        private fun getPageList(call: MethodCall, result: MethodChannel.Result) = kotlinx.coroutines.launch(call, result) {
            val sourceId = call.arg<String>("sourceId")
            val isAnime = call.arg<Boolean>("isAnime")
            val map = call.arg<Map<String, Any?>>("episode")
