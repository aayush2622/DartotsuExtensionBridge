...
open class TRsTX : ExtractorApi() {
    ...
    override suspend fun getUrl(url: String, referer: String?, subtitleCallback: (SubtitleFile) -> Unit, callback: (ExtractorLink) -> Unit) {
        ...
        val rawList  = app.post(postLink, headers = mapOf("Referer" to extRef)).parsedSafe<List<Any>>() ?: throw ErrorLoadingException("Post link not found")
        ...
        for (item in postJson) {
            ...
            val videoData = app.post(fileUrl, headers = mapOf("Referer" to extRef)).text
