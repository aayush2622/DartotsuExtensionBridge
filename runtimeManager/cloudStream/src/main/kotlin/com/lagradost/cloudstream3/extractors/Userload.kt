...
open class Userload : ExtractorApi() {
    ...
    override suspend fun getUrl(url: String, referer: String?): List<ExtractorLink>? {
        ...
        val videoLinkPage = app.post("$mainUrl/api/request/", requestBody = "morocco=$morocco&mycountry=$mycountry".toRequestBody("application/x-www-form-urlencoded".toMediaTypeOrNull()))
